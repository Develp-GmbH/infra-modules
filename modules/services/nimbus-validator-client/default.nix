{
  ...
  inherit (lib) mkEnableOption mkOption mkIf types filterAttrs escapeShellArgs literalExpression;

  cfg = config.services.ethereum.nimbus-validator-client;
  ...
  options = {
    services.ethereum = {
      nimbus-validator-client = {
        ...
        package = mkOption {
          type = types.package;
          default = pkgs.nimbus_validator_client;
          ...
          type = lib.types.submodule {
            ...
            options = {
              ...
              web3-signer-update-interval = mkOption {
                type = types.int;
                default = 20;
                description = "Number of seconds between validator list updates [=20].";
              };
